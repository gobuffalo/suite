...
* `hash(string, opts)` - will create the hashed value of the string (usefull for creating a password), you can define the cost as an opts (the default is `bcrypt.DefaultCost`)
